...
[`Github Repo Link`](https://github.com/HanumanTheHacker/SIHOBJECT.git)

## Steps to run Code

- Clone the repository
```
git clone [https://github.com/MuhammadMoinFaisal/YOLOv8-DeepSORT-Object-Tracking.git](https://github.com/HanumanTheHacker/SIHOBJECT.git)
```
